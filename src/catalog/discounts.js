...
export function defaultDiscounts(){ return [
  ...
  {id:'bk_gen', ch:'booking', name:'Genius (constante)', kind:'constant', group:'proactive', category:'Premium Programmes', pct:10, on:true, note:'lo funde el host; L1=10%'},
  {id:'bk_mob', ch:'booking', name:'Mobile Rate', kind:'constant', group:'proactive-mobile', category:'Targeting', pct:10, on:true, note:'apila con Genius; no con Country/Limited'},
  {id:'bk_cty', ch:'booking', name:'Country Rate', kind:'constant', group:'proactive-country', category:'Targeting', pct:0, on:false},
  {id:'bk_esc', ch:'booking', name:'Oferta Escapada (Campaign deal)', kind:'constant', group:'campaign', category:'Campaign deals', pct:0, on:false, note:'apila solo con Genius; no combina con Targeting (Mobile/Country) ni con Portfolio deals'},
  {id:'bk_lmd', ch:'booking', name:'Last-Minute Deal', kind:'window', group:'reactive', category:'Portfolio deals', pct:0, from:0, to:3, on:false},
  {id:'bk_ebd', ch:'booking', name:'Early Booker Deal', kind:'window', group:'reactive', category:'Portfolio deals', pct:0, from:30, to:9999, on:false},
  {id:'bk_bas', ch:'booking', name:'Basic Deal', kind:'constant', group:'reactive', category:'Portfolio deals', pct:0, on:false},
  {id:'bk_ltd', ch:'booking', name:'Limited-time Deal', kind:'constant', group:'reactive-limited', category:'Deep deals', pct:0, on:false, note:'ruta exclusiva: no combina con Genius, Targeting ni otros deals'},
  {id:'bk_los1', ch:'booking', name:'Duración de estadía A (≥7 noches)', kind:'los', group:'los', category:'Duración de estadía', pct:0, minN:7, on:false, note:'es tu tarifa (Rates & Availability → Discounts → duración de estadía), se apila dentro de cualquier ruta; noches y % editables'},
  {id:'bk_los2', ch:'booking', name:'Duración de estadía B (≥14 noches)', kind:'los', group:'los', category:'Duración de estadía', pct:0, minN:14, on:false, note:'noches y % editables, ajusta o apaga'},
  {id:'bk_los3', ch:'booking', name:'Duración de estadía C (≥28 noches)', kind:'los', group:'los', category:'Duración de estadía', pct:0, minN:28, on:false, note:'noches y % editables, ajusta o apaga'},
