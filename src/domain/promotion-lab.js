...
*/
import {compute, combineChannel, payoutFactor} from './engine.js';
...
/* Estas dos funciones pertenecían al motor de la revisión histórica, pero son
   utilidades de solo lectura del laboratorio. Se mantienen aquí para no
   ampliar el contrato de engine.js ni alterar sus reglas de producción. */
